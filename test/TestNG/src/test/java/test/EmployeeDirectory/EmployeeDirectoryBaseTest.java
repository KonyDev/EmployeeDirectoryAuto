...
public class EmployeeDirectoryBaseTest extends AppBaseTest{
	...
	public void beforeClass(
			@Optional("EmployeeDirectory") String appNamePerClass,
			@Optional("com.verticalapps.EmployeeDirectory") String packageNamePerClass,
			@Optional("<launchactivityname>") String activityNamePerClass,
			@Optional("com.verticalapps.EmployeeDirectory") String bundleId) throws Exception {
